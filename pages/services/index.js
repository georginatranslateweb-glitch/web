                                ...
                                <div className="top">
                                    <div className="row">
                                        ...
                                        <div className="col-lg-8 col-md-8">
                                            <h1 className="title">NAATI-Certified Translations.</h1>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="team-rules-area-inner">
                                ...
                                <div className="top">
                                    <div className="row">
                                        ...
                                        <div className="col-lg-8 col-md-8">
                                            <h1 className="title">Localisation Services</h1>
                                        </div>
                                    </div>
                                </div>
                                <div className="middle">
                                        ...
                                        <div className="col-lg-4 col-md-6">
                                            <div className="inner">
                                                ...
                                                <div className="content">
                                                    ...
                                                    <ul>
                                                        <p><li> <span className="services-list__label">Digital Content:</span> Websites, apps, and UX copy.</li></p>
                                                        <p> <li> <span className="services-list__label">Marketing & brands:</span> Campaigns and brand communication</li></p>
                                                        <p> <li> <span className="services-list__label">Social media:</span> Engaging, culturally relevant posts</li></p>
                                                        <p> <li> <span className="services-list__label">Cultural review:</span> Nuance and linguistic checks</li></p>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-lg-4 col-md-6">
                                            <div className="inner">
                                                ...
                                                <div className="content">
                                                    ...
                                                    <h2 className="sub-title">What I do</h2>
                                                    <ul>
                                                        <p><li> <span className="services-list__label">Translation review:</span> Double-checking accuracy and flow.</li></p>
                                                        <p> <li> <span className="services-list__label">Editing & Proofreading:</span> Polishing grammar, spelling, and style.</li></p>
                                                        <p> <li> <span className="services-list__label">Quality assurance checks:</span> Final checks before publishing or submitting.</li></p>
                                                        <p> <li> <span className="services-list__label">Formatting and consistency review:</span> Ensuring a clean, uniform look.</li></p>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
