...
const HomeSixPartner = () => {
    return (
        <div className="clients-area2">
            <div className="ms-tt-wrap">
                <ul className="ms-tt">
                    <li className="ms-tt__text"><Image src={partnerImg1} alt="logo" /></li>
                    <li className="ms-tt__text"><Image src={partnerImg2} alt="logo" /></li>
                    <li className="ms-tt__text"><Image src={partnerImg3} alt="logo" /></li>
                    <li className="ms-tt__text"><Image src={partnerImg4} alt="logo" /></li>
                    <li className="ms-tt__text"><Image src={partnerImg5} alt="logo" /></li>
                    <li className="ms-tt__text"><Image src={partnerImg6} alt="logo" /></li>
                    <li className="ms-tt__text"><Image src={partnerImg7} alt="logo" /></li>
                    <li className="ms-tt__text"><Image src={partnerImg8} alt="logo" /></li>
                    <li className="ms-tt__text"><Image src={partnerImg9} alt="logo" /></li>
                    <li className="ms-tt__text"><Image src={partnerImg1} alt="logo" /></li>
                    <li className="ms-tt__text"><Image src={partnerImg2} alt="logo" /></li>
                    <li className="ms-tt__text"><Image src={partnerImg3} alt="logo" /></li>
                    <li className="ms-tt__text"><Image src={partnerImg4} alt="logo" /></li>
