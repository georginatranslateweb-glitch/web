...
const SERVICE_LABELS = {
  ...
  naati_translation: 'NAATI Translation',
        ...
        <tr>
          <td style="padding:32px;color:#1a1a1a;font-size:15px;line-height:1.6;">
            ...
            <table role="presentation" width="100%" style="margin-bottom:24px;font-size:14px;">
              ...
              <tr><td style="padding:6px 0;color:#666;">Translation purpose</td><td>${escapeHtml(DOCUMENT_LABELS[fields.documentType] || fields.documentType)}</td></tr>
